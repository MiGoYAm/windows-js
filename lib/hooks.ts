...
import { DependencyList, SetStateAction, useCallback, useEffect, useLayoutEffect, useMemo, useRef } from "react";
...
export const [browserWindowAtom, useWindowListener] = atomWithListeners<{ width: number; height: number } | null>(
  null,
);
